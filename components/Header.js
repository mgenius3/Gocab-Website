    ...
    <div className="fixed top-0 w-full z-30 clearNav md:bg-opacity-90 transition duration-300 ease-in-out">
      <div className="flex flex-col max-w-6xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        <div className="flex flex-row items-center justify-between p-4">
          ...
          >
            <h1 className="text-4xl Avenir tracking-tighter text-blue-600 md:text-4x1 lg:text-3xl">
              Gocab
            </h1>
          </Link>
          <button
        ...
        >
          <nav className="flex-col flex-grow ">
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link
                  className="inline-flex items-center px-4 py-2 mt-2 font-medium text-blue-600 transition duration-500 ease-in-out transform bg-transparent rounded-lg text-md md:mt-0 md:ml-4 bg-gray-900"
                  href="/#download"
                >
